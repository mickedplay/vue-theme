...
const t = {}, d = { class: "app-container w-full h-screen grid overflow-hidden default-transition grid-cols-[4rem,1fr] lg:grid-cols-[16rem,1fr] grid-rows-[4rem,1fr,5rem] lg:grid-rows-[4rem,1fr,3rem]" };
...
const g = /* @__PURE__ */ s(t, [["render", i], ["__scopeId", "data-v-a276a980"]]);
export {
  g as default
};
